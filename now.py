...
mid_col.subheader("Top {} Produsen Minyak Mentah".format(topn))
...
left_col.markdown('Penghasil Minyak Terbesar pada Tahun {}:'.format(tahun))
...
left_col.markdown('Penghasil Minyak Terbesar of All Time (NON KUMULATIF) :')
...
left_col.markdown('Penghasil Minyak Terbesar of All Time (KUMULATIF) :')
...
mid_col.markdown('Penghasil Minyak Terkecil pada Tahun {}:'.format(tahun))
...
mid_col.markdown('Penghasil Minyak Terkecil of All Time (NON KUMULATIF) :')
...
mid_col.markdown('Penghasil Minyak Terkecil of All Time (KUMULATIF) :')
...
left_col.markdown('Bukan Penghasil Minyak tahun {} :'.format(tahun))
count=1
...
mid_col.markdown("Negara-negara yang bukan merupakan produsen:")
